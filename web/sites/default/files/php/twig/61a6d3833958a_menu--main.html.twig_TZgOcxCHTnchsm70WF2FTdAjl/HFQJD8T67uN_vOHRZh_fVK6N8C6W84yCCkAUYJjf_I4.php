...
/* themes/custom/ponal_theme/templates/navigation/menu--main.html.twig */
class __TwigTemplate_a6a1ffd2781c5401d4d480485df2666c5077681a8c1053aeb04f4db4c25627bb extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 33
                    echo "      <ul";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->withoutFilter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "navbar-nav mx-auto"], "method", false, false, true, 33), 33, $this->source), "id"), "html", null, true);
                    echo ">
    ";
                } else {
                    // line 35
...
($context["menu_level"] ?? null)) ? ("dropdown-item") : ("nav-item px-lg-4")), 1 => ((twig_get_attribute($this->env, $this->source,                     // line 41
...
($context["menu_level"] ?? null)) ? ("nav-link text-uppercase") : ("")), 1 => ((twig_get_attribute($this->env, $this->source,                     // line 51
...
$context["item"], "url", [], "any", false, false, true, 54), "toString", [], "method", false, false, true, 54), 54, $this->source)))];
  ...
  ";
    ...
    {
        return "themes/custom/ponal_theme/templates/navigation/menu--main.html.twig";
    }
    ...
    {
        return new Source("", "themes/custom/ponal_theme/templates/navigation/menu--main.html.twig", "C:\\xampp\\htdocs\\piloto_drupal\\web\\themes\\custom\\ponal_theme\\templates\\navigation\\menu--main.html.twig");
    }
